...
"A": {
 "desc": ["🟢 **main:** chest press, lat pulldown, cable row.",
          "🟠 **arms:** incline curl, overhead extension.",
 ...
 "ex": [
  ...
  ("arms: Incline Curl, Dumbbell", "4x8", "8kg 75s", "none", None, "dp(2kg, 8, 12)", "aTYlqC_JacQ",
  ...
  ("arms: Triceps Extension, Cable", "4x10", "25kg 75s", "none", None, "dp(2.5kg, 10, 15)", "kqidUIf1eJE",
...
"B": {
 ...
 "ex": [
  ...
  ("arms: Preacher Curl, EZ Bar", "4x8", "15kg 75s", "none", None, "dp(2.5kg, 8, 12)", "sxA__DoLsgo",
  ...
  ("arms: Triceps Pushdown, Cable", "4x10", "25kg 75s", "none", None, "dp(2.5kg, 10, 15)", "6Fzep104f0s",
...
"C": {
 "desc": ["🟢 **main:** dumbbell bench, chin-up, one-arm row.",
          "🟠 **arms:** Bayesian curl, dumbbell overhead extension.",
 ...
 "ex": [
  ...
  ("arms: Bicep Curl, Cable", "4x8", "12.5kg 75s", "none", None, "dp(2.5kg, 8, 12)", "paM4Yo8fo8g",
  ...
  ("arms: Triceps Extension, Dumbbell", "4x10", "16kg 75s", "none", None, "dp(2kg, 10, 15)", "YbX7Wd8jQ-Q",
...
SUBLINES = {
  ...
  "iixND1P2lik": "sub: Bicep Curl, Dumbbell / 4x8 10kg 75s / warmup: none / progress: dp(2kg, 8, 12)",
  "YbX7Wd8jQ-Q": "sub: Triceps Extension, Dumbbell / 4x10 16kg 75s / warmup: none / progress: dp(2kg, 10, 15)",
  ...
  "M_uPvGrMx_o": "sub: Preacher Curl, Leverage Machine / 4x8 25kg 75s / warmup: none / progress: dp(2.5kg, 8, 12)",
  "OQ4TWXkZjTc": "sub: Skullcrusher, EZ Bar / 4x10 15kg 75s / warmup: none / progress: dp(2.5kg, 10, 15)",
  ...
  "XOEL4MgekYE": "sub: Hammer Curl, Dumbbell / 4x8 10kg 75s / warmup: none / progress: dp(2kg, 8, 12)",
...
// * Every exercise note starts with a colour. 🟢 MAIN = presses and pulls, never skip. 🟠 ARMS = curls and triceps, 75 sec rest. ⚪ EXTRA = delts, flyes, legs, cut these if short on time.
